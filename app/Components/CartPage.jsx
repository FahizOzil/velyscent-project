...
export default function CartPage() {
  ...
  const discount = promoApplied ? subtotal * 0.1 : 0; // 10% off
            ...
            <div className="cart-grid" style={{
              ...
              <div>
                  ...
                  <div key={`${item.slug}-${item.variant}`} style={{
                    ...
                    <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                      ...
                      <div style={{
                        ...
                        */}
                        <svg width="20" height="20" fill="none" stroke="rgba(196,145,79,0.3)"
                ...
                <div style={{ marginTop: "20px" }}>
                  <button onClick={clearCart} style={{
                    background: "none", border: "none",
                    fontFamily: "'Jost', sans-serif",
                    fontSize: "12px", color: "rgba(255,100,100,0.5)",
              ...
              <div style={{
                ...
                {[
                  ...
                  promoApplied && { label: "Discount (10%)", value: `- $ ${discount.toFixed(2)}`, gold: true },
                  ...
                  <div key={row.label} style={{
                    ...
                    <span style={{
                      ...
                      color: row.gold ? "#C4914F" : "rgba(255,255,255,0.75)",
                    }}>
                      {row.value}
                    </span>
                  </div>
                ...
                {shipping === 0 && (
                  <p style={{
                    fontFamily: "'Jost', sans-serif",
                    fontSize: "11px", color: "rgba(196,145,79,0.6)",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "24px" }}>
                  ...
                  <span style={{
                    fontFamily: "'Playfair Display', serif",
                    fontSize: "18px", fontWeight: 700, color: "#C4914F",
                  }}>
                    $ {total.toFixed(2)}
                  </span>
                </div>
                ...
                <div style={{ marginBottom: "20px" }}>
                  <div style={{ display: "flex", gap: "8px" }}>
                    ...
                    <button onClick={handlePromo} style={{
                      padding: "10px 16px",
                      background: "rgba(196,145,79,0.15)",
                      border: "1px solid rgba(196,145,79,0.3)",
                      borderRadius: "6px", color: "#C4914F",
                      fontFamily: "'Jost', sans-serif",
                ...
                <Link href="/checkout" style={{
                  ...
                  background: "#C4914F", border: "none", borderRadius: "6px",
                  color: "#fff", fontFamily: "'Jost', sans-serif",
