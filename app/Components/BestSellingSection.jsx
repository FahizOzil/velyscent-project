  ...
  return (
    <div
      ...
      style={{
        ...
        border: hovered ? "1px solid rgba(196,145,79,0.35)" : "1px solid rgba(255,255,255,0.06)",
      ...
      <div style={{
        ...
        {product.images?.[0] ? (
          ...
          <div style={{
            ...
            <svg width="36" height="36" fill="none" stroke="rgba(196,145,79,0.35)" strokeWidth="1.2" viewBox="0 0 24 24">
