      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px", alignItems: "flex-end" }}>
          ...
          <span style={{
            ...
            fontSize: "16px", fontWeight: 600, color: "#C4914F",
          }}>
        ...
        {/* Expand arrow */}
        <svg width="16" height="16" fill="none" stroke="rgba(255,255,255,0.3)"
        ...
        <div style={{
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px", flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    ...
                    */}
                    <svg width="14" height="14" fill="none" stroke="rgba(196,145,79,0.3)"
          ...
          <div style={{
            ...
            {[
              ...
              { label: "Shipping", value: order.shipping === 0 ? "Free" : `$ ${parseFloat(order.shipping).toFixed(2)}` },
            ].map((r) => (
